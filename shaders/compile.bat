...
glslc "%GLSL_DIR%\rgba8_to_xyb.comp" -o "%SPIRV_DIR%\rgba8_to_xyb.spv"
if errorlevel 1 (echo FAILED: rgba8_to_xyb.comp & exit /b 1)
echo   rgba8_to_xyb.comp OK
...
glslc "%GLSL_DIR%\gaussian_blur_error_reduce.comp" -o "%SPIRV_DIR%\gaussian_blur_error_reduce.spv"
if errorlevel 1 (echo FAILED: gaussian_blur_error_reduce.comp & exit /b 1)
echo   gaussian_blur_error_reduce.comp OK
